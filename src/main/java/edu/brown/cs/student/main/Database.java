...
public class Database {
  ...
  Database(String filename) throws SQLException, ClassNotFoundException {
     ...
     */
    try {
      // this line loads the driver manager class, and must be present for everything else to work properly
...
// these two lines tell the database to enforce foreign keys during operations, and should be present
   ...
   *
   * @return Map
   * @throws SQLException if something goes wrong with an SQL query.
   */
